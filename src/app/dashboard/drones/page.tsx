...
export default async function DronesPage() {
  ...
  const inventoryDrones = items.filter(
    (d) => d.status === "inventory" || !d.latitude,
  );
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Drone Management Area
          </p>
        </div>
        <Card className="w-full max-w-auto h-fit">
            ...
            <div className="space-y-2">
              ...
              {inventoryDrones.length > 0 ? (
                ...
                <p className="text-gray-500 text-sm">
                  No drones in inventory. Create one to get started!
                </p>
              )}
            </div>
